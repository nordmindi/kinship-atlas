-- Story Artifacts Migration
-- This migration creates the artifacts system for connecting artifacts to stories
-- Created: 2025-01-24
...
-- Create story_artifacts junction table (many-to-many relationship between stories and artifacts)
